...
ipaddr targets C++20 and builds with clang ≥ 14 or gcc ≥ 11. It depends
...
If you already have ipaddr and polycpp checked out side by side, tell
...
issue on the `repository <https://github.com/polycpp/ipaddr/issues>`_
